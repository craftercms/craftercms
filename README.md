...
By default, this project will build both environments unless instructed otherwise. The `authoring` environment runs at [http://localhost:25500/studio](http://localhost:25500/studio), whereas the `delivery` environment runs at [http://localhost:9080/studio](http://localhost:9080/).
