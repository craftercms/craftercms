...
/**
 * Copied from https://github.com/spring-projects/spring-security/blob/6.5.7/web/src/main/java/org/springframework/security/web/util/matcher/AntPathRequestMatcher.java
 * to preserve ant path matching capabilities no longer available in Spring 7.
 */
