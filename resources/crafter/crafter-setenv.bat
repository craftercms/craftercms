...
SET CATALINA_OPTS=-Dcatalina.logs="%CATALINA_LOGS_DIR%" -server -Xss1024K -Xms1G -Xmx4G -Dapplication.logs="%CRAFTER_APPLICATION_LOGS%" -Dcrafter.data.dir="%CRAFTER_DATA_DIR%"
