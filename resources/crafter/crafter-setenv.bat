...
SET SOLR_DEBUG_PORT=@SOLR_DEBUG_PORT@
...
FOR %%P in (%*) DO (
  IF "%%P"=="forceMongo" SET FORCE_MONGO=true
  ELSE IF "%%P"=="withSolr" SET WITH_SOLR=true
  ELSE IF "%%P"=="skipElasticSearch" SET SKIP_ELASTICSEARCH=true
)
