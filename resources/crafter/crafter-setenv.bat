...
SET "CATALINA_LOGS_DIR=%CRAFTER_ROOT%\logs\tomcat"
...
SET "SOLR_INDEXES_DIR=%CRAFTER_ROOT%\data\indexes"
...
SET "DEPLOYER_DATA_DIR=%CRAFTER_ROOT%\data\deployer"
SET "DEPLOYER_TARGET_DIR=%DEPLOYER_DATA_DIR%\targets"
SET "DEPLOYER_PRODCESSED_COMMITS_DIR=%DEPLOYER_DATA_DIR%\processed-commits"
SET "DEPLOYER_LOGS_DIR=%CRAFTER_ROOT%\logs\deployer"
SET "DEPLOYER_DEPLOYMENTS_DIR=%CRAFTER_ROOT%\data\repos\sites"
...
SET "MONGODB_PID=%CRAFTER_ROOT%\data\mongodb\mongod.lock"
SET "MONGODB_DATA_DIR=%CRAFTER_ROOT%\data\mongodb"
SET "MONGODB_LOGS_DIR=%CRAFTER_ROOT%\logs\mongodb"
SET TOMCAT_HTTP_PORT=@TOMCAT_HTTP_PORT@
SET "MYSQL_DATA=%CRAFTER_ROOT%\data\db"
