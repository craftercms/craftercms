...
IF NOT DEFINED CRAFTER_BIN_DIR (for %%i in ("%~dp0..\..") do set "CRAFTER_BIN_DIR=%%~fi\")
...
IF NOT DEFINED DEPLOYER_HOME (SET DEPLOYER_HOME=%CRAFTER_BIN_DIR%\bin\crafter-deployer)
...
SET DEPLOYER_PID_FILE=%CRAFTER_BIN_DIR%\crafter-deployer.pid
