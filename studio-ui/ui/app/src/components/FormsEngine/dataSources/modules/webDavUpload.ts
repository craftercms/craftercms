...
export const webDavUploadDataSourceModule: DataSourceModule = defineDataSourceModule({
	...
	create({ record }) {
		...
		return createInstanceFromRecord(record, webDavUploadDataSourceModule, {
			capabilities: ['upload'],
			getActions() {
				return [
...
export default webDavUploadDataSourceModule;
